...
cfg.item_transformers = {
  -- example of harvest item transformer
    ...
    max_units=25,
    units_per_minute=1,
    x=-2320.4145507813,y=-3743.7319335938,z=3.6978271007538, 
    radius=10, height=5, -- area
    recipes = {
 ...
 -- {
  ...
  {
    name="DMV Driver License", -- menu name
    r=255,g=125,b=0, -- color
    max_units=1,
    units_per_minute=1,
    x=-217.29096984863,y=-1920.6636962891,z=27.77000617981,        
    radius=2, height=1.0, -- area
    recipes = {
      ["Driver"] = { -- action name
  ...
  -------------------------------drugs
    {
    name="Grow Plants $ 50", -- menu name
	permissions = {"harvest.weed"}, -- you can add permissions
    r=255,g=125,b=0, -- color
    max_units=100000,
    units_per_minute=100000,
    x=1050.4840087891,y= -3197.19921875,z= -39.13037109375,
    radius=2, height=1.0, -- area
    recipes = {
      ["Growing"] = { -- action name
       description="Growing Plants...", -- action description
    ...
    {
    name="Weed Trimming", -- menu name
	permissions = {"harvest.weed"}, -- you can add permissions
    r=255,g=125,b=0, -- color
    max_units=100000,
    units_per_minute=100000,
    x=1032.9378662109,y=-3205.548828125,z=-38.180435180664,
    radius=2, height=1.0, -- area
    recipes = {
      ["Trimming"] = { -- action name
       description="Trimming Weed...", -- action description
        in_money=0, -- money taken per unit
        out_money=0, -- money earned per unit
        reagents={["weed_plant"] = 1
		}, -- items taken per unit
        products={
		["weed"] = 2
		}, -- items given per unit
...
cfg.informer = {
  ...
  interval = 15, -- interval in minutes for the reseller respawn
