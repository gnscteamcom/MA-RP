...
cfg.groups = {
  ...
  ["RA"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"You are a member of the Raining Ammo."}) end
	},
    "police.menu",		-- Acces to the police menu to use all of the things below.
	"police.easy_cuff", -- Acces to cuff someone
	"police.drag",		-- Acces to drag a a cuffed person
	...
	"police.store_weapons", -- Acces to store weapons
	"mafia.vehicle", -- Acces to the garage.
	"RA.whitelisted", -- Whitelisted group
	"ra.paycheck" -- Paycheck ( if you want)
  },
  ["Medical Transport"] = {
    _config = { gtype = "job",
  ...
  ["Taxi"] = {
    _config = { gtype = "job",
	onspawn = function(player) vRPclient.notify(player,{"You are Taxi, PRESS DEL TO START MISSIONS. Salary : $2000."}) end
	},
    "uber.service",
	"uber.vehicle",
	"uber.mission",
...
cfg.selectors = {
  ...
  ["Mafia"] = {
    ...
    ["RA"] = {
    _config = {x = 1984.5054931641, y = 3054.8696289063, z = 47.215187072754, blipid = 351, blipcolor = 3, permissions = {"RA.whitelisted"} }, -- UPDATE THE COORDINATES
	"President",
	"Vice President",
	"Road Caption",
	"Enforcer",
