...
local ups_male = { model = "s_m_m_ups_01"}
local ups_male2 = { model = "s_m_m_ups_02"}
...
cfg.cloakrooms = {
  ...
  {"UPS",-442.37158203125,6150.556640625,31.478204727173},
  ...
  {"Firefighters",197.40306091309,-1651.9963378906,29.803216934204}
