...
Citizen.CreateThread(function()
  while true do
    ...
    if handcuffed then
	  ...
	  DisableControlAction(0,266,true) -- disable move left 
	  DisableControlAction(0,267,true) -- disable move right
	  DisableControlAction(0,268,true) -- disable move up
	  DisableControlAction(0,269,true) -- disable move down
    end
  end
end)
