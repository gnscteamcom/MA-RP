...
local deformationMultiplier = 7.0				-- How much should the vehicle visually deform from a collision. Range 0.0 to 10.0 Where 0.0 is no deformation and 10.0 is 10x deformation. -1 = Don't touch
...
local mechanics = {
	{name="Mechanic", id=446, r=25.0, x=-1162.67, y=-1689.450 , z=4.4},		-- Auto Shop, Grand Senora Desert
	{name="Court House", id=89, r=25.0, x=237.856,   y=-412.880,  z=48.11}		-- court house
...
local fixMessages = {
	"You put the spark plugs back in",
	"You stopped the oil leak using chewing gum",
	"You repaired the oil tube with gaffer tape",
	"You tightened the botls on the battery and it magically came back to life",
	"You kicked the engine and it magically came back to life",
	"You removed some rust from the crank case",
...
local noFixMessages = {
	"You checked the oil plug. It's not there. Call a tow truck",
	"You looked at your engine, it seemed fine, but its really not. Call a tow truck",
	"You made sure that the gaffer tape was still holding the engine together. Call a tow truck",
	"You turned up the radio volume. It just drowned out the weird engine noises. Call a tow truck",
	"Never fix something that ain't broken they said. You didn't listen. At least it didn't get worse. Call a tow truck"
}
local noFixMessageCount = 5
