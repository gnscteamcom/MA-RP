...
local banks = {
	...
	["fleeca3"] = {
		position = { ['x'] = 265.39184570313, ['y'] = 213.81965637207, ['z'] = 101.68338775635 },
		reward = 90000 + math.random(100000,200000),
		nameofbank = "Main City Bank Volt",
		lastrobbed = 0
	},
	--["fleeca4"] = {
  ...
  if vRP.hasGroup({user_id,"cop"}) then
    ...
    if #cops >= 2 then -- change 2 to the minimum amount online necessary
	  if banks[robb] then
		  ...
		  TriggerClientEvent('chatMessage', player, 'SYSTEM', {255, 0, 0}, "Hold the fort for ^1 7 ^0minutes and the money is yours!")
