        ...
        for i = 1, #doorList do
            ...
            if(playerDistance < 1.15) then
				...
				if doorList[i]["locked"] == true then
                    DrawText3d(doorList[i]["txtX"], doorList[i]["txtY"], doorList[i]["txtZ"], "~ b ~ The door ~ r ~ is locked")
                else
                    DrawText3d(doorList[i]["txtX"], doorList[i]["txtY"], doorList[i]["txtZ"], "~ b ~ The door ~ g ~ is unlocked")
                end
