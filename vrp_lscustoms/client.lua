...
local lsc = {
	...
	locations = { -- LSCUSTOMS LOCATIONS -- ADD SERVER LOCKS TOO
		[1] = { locked = false, outside = { x = 463.848, y = -1016.231, z = 28.076, heading = 71.187133}, inside = {x = 463.848, y = -1016.231, z = 28.076, heading = 269.455}},
...
function DriveOutOfGarage(pos)
    ...
    local vehicle = GetLabelText(GetDisplayNameFromVehicleModel(model))
     --dump(modPrice)
		-- The mods can not be saved if they do not exist.
		-- Must find out if I can read them somehow
	print(vehicle)
	print("pre-triger event")
    TriggerServerEvent('lscustoms:UpdateVeh2', vehicle, plate, colors[1], colors[2], extra_colors[1], extra_colors[2], mods)
